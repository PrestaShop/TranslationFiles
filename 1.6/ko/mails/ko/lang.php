...
$_LANGMAIL['Your guest account has been transformed into a customer account'] = '당신의 비회원 계정이 고객 계정으로 전환되었습니다.';
...
$_LANGMAIL['An answer to your message is available #ct%1$s #tc%2$s'] = '질문에 대한 답변이 등록되었습니다. #ct%1$s #tc%2$s';
...
$_LANGMAIL['Your message has been correctly sent #ct%1$s #tc%2$s'] = '메시지가 #ct%1$s #tc%2$s 발송됨';
...
$_LANGMAIL['Password query confirmation'] = '비밀번호 변경을 요청하셨습니다.';
$_LANGMAIL['Newsletter voucher'] = '뉴스레터 - 할인 쿠폰';
$_LANGMAIL['Newsletter confirmation'] = '뉴스레터 확인';
$_LANGMAIL['Email verification'] = '뉴스레터 구독';
$_LANGMAIL['Your wishlist\'s link'] = '당신의 관심상품 링크';
