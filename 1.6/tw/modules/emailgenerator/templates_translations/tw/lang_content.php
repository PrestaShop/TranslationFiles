...
$_LANGMAIL['Thank you for creating a customer account at {shop_name}.'] = '感謝您在 {shop_name} 創建帳戶。';
$_LANGMAIL['Your {shop_name} login details'] = '您的 {shop_name} 登錄詳情';
$_LANGMAIL['Here are your login details:'] = '以下是您的登錄詳情：';
$_LANGMAIL['E-mail address:'] = '電郵地址：';
$_LANGMAIL['Password:'] = '密碼：';
$_LANGMAIL['Important Security Tips:'] = '安全提示：';
$_LANGMAIL['Always keep your account details safe.'] = '小心保護您的的帳戶資料，防止盜竊。';
$_LANGMAIL['Never disclose your login details to anyone.'] = '千萬不要向任何人透露您的登錄信息。';
$_LANGMAIL['Change your password regularly.'] = '定期更改密碼。';
$_LANGMAIL['Should you suspect someone is using your account illegally, please notify us immediately.'] = '如懷疑有人違法使用您的帳戶，請立即通知我們。';
$_LANGMAIL['You can now place orders on our shop:'] = '您現在可以在我們的店鋪下單了：';
$_LANGMAIL['A new order has been generated on your behalf.'] = '您的新訂單已經生成。';
...
$_LANGMAIL['Your order with the reference <span><strong>{order_name}</strong></span> has been placed successfully and will be <strong>shipped as soon as we receive your payment</strong>.'] = '編號為 <span><strong>{order_name}</strong></span> 的訂單已成功下置，我們將在<strong>收到付款後馬上發貨</strong> 。';
$_LANGMAIL['You have selected to pay by wire transfer.'] = '你選擇以電匯付款。';
$_LANGMAIL['Here are the bank details for your transfer:'] = '請將款項電匯到以下銀行：';
$_LANGMAIL['Amount:'] = '金額：';
...
$_LANGMAIL['You can review this credit slip and download your invoice from the <a href="{history_url}">"My credit slips"</a> section of your account by clicking <a href="{my_account_url}">"My account"</a> on our shop.'] = '您可以閱覽此代金券，並在我們店鋪<a href="{history_url}">"我的代金券"</a> 下載您的發票，請直接點擊 <a href="{my_account_url}"> "我的帳户"</a>。';
$_LANGMAIL['Thank you for your order with the reference {order_name} from <strong>{shop_name}</strong>'] = '感謝您的訂購，您的訂單號為<strong>{order_name}</strong>';
...
$_LANGMAIL['If you have a guest account, you can follow your order via the <a href="{guest_tracking_url}?id_order={order_name}">"Guest Tracking"</a> section on our shop.'] = '如果您是非會員帳戶，您可以在我們店舖的 <a href="{guest_tracking_url}?id_order={order_name}">"非會員進踪"</a> 頁面追踪您的訂單。';
$_LANGMAIL['Your {shop_name} login information'] = '您 {shop_name} 的登錄信息';
