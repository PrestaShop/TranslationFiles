...
$_LANGMAIL['Credit slip created'] = 'Credit note created';
$_LANGMAIL['We have generated a credit slip in your name for order with the reference <span><strong>{order_name}</strong></span>.'] = 'We have generated a credit note in your name for order with the reference <span><strong>{order_name}</strong></span>.';
...
$_LANGMAIL['Order canceled'] = 'Order cancelled';
$_LANGMAIL['Your order with the reference <span><strong>{order_name}</strong></span> from <span><strong>{shop_name}</strong></span> has been canceled.'] = 'Your order with the reference <span><strong>{order_name}</strong></span> from <span><strong>{shop_name}</strong></span> has been cancelled.';
