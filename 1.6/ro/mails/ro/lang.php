...
$_LANGMAIL['Your guest account has been transformed into a customer account'] = 'Contul tau de oaspete a fost transformat in unul de client';
...
$_LANGMAIL['New message regarding your order'] = 'Mesaj nou privind comanda ta';
...
$_LANGMAIL['Message from contact form'] = 'Mesaj de la formularul de contact';
$_LANGMAIL['Message from a customer'] = 'Mesaj de la un client';
$_LANGMAIL['Password query confirmation'] = 'Confirmarea parolei';
$_LANGMAIL['Newsletter voucher'] = 'Cupon din buletinul informativ';
$_LANGMAIL['Newsletter confirmation'] = 'Confirmarea abonarii la buletinul informativ';
