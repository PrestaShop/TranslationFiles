...
$_LANGMAIL['An answer to your message is available #ct%1$s #tc%2$s'] = 'Jawapan untuk mesej anda tersedia di #ct%1$s #tc%2$s';
$_LANGMAIL['Your new password'] = 'Katalaluan baru anda';
...
$_LANGMAIL['Your message has been correctly sent #ct%1$s #tc%2$s'] = 'Mesej anda telah berjaya dihantar #ct%1$s #tc%2$s';
$_LANGMAIL['Your message has been correctly sent'] = 'Mesej anda telah dihantar dengan betul';
$_LANGMAIL['Message from contact form'] = 'Mesej dari borang hubungan';
$_LANGMAIL['Message from a customer'] = 'Mesej dari seorang pelanggan';
$_LANGMAIL['Password query confirmation'] = 'Pengesahan kata laluan';
$_LANGMAIL['Newsletter voucher'] = 'Baucar buletin';
$_LANGMAIL['Newsletter confirmation'] = 'Pengesahan buletin';
$_LANGMAIL['Email verification'] = 'Pengesahan e-mel';
$_LANGMAIL['%1$s sent you a link to %2$s'] = '%1$s beri anda pautan ke %2$s';
